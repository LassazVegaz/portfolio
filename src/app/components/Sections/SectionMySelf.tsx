    ...
    <section id="about-me" className="about section-container section-spacing">
      ...
      <div className="about-grid">
        ...
        <div className="about-copy">
          ...
          <p>
            Most recently, I built and maintained secure systems for
            Singapore&apos;s Economic Development Board. I&apos;m at my best
            where product thinking, architecture, and hands-on engineering
            meet—simplifying complexity without losing sight of reliability.
          </p>
          <div className="about-links">
            <a
              href="https://medium.com/@lasindunuwangaweerasinghe"
              target="_blank"
            ...
            <a
              href="https://www.fiverr.com/lassaz_vegaz"
              target="_blank"
              rel="noopener noreferrer"
            >
              Fiverr profile ↗
